...
- 发布时可选择「仅出售」或「支持换书」，支持换书需填写想换到的书
...
### 换书系统
- 买家从自己发布的「可购买」书籍中选择一本，向支持换书的目标书提交换书申请（可留言）
- 同一买家对同一目标书只能存在一条待处理申请
- 卖家在书籍详情页接受/拒绝申请；接受时双方两本书在同一事务中同时变为「已预约」
- 接受时任一本书已被占用或下架则整次失败、不产生任何状态变更（支持并发接受）
- 卖家拒绝或买家取消（含已接受的申请）后，双方书籍自动释放为「可购买」
